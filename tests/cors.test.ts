...
// The middleware only enforces the origin allowlist in production mode — in
// dev/test every origin is allowed. Mock a production config so the rejection
...
describe('CORS Middleware', () => {
  ...
  describe('Preflight Requests', () => {
    it('should handle OPTIONS preflight requests', async () => {
      ...
      // The cors package answers preflights with its default 204 No Content.
